...
public class VersionInfo {
     ...
     *                  for example "org.kodtik.innovations.http".
    ...
    public static VersionInfo loadVersionInfo(final String pckg,
        ...
        try {
            // org.kodtik.innovations.http      becomes
     ...
     * @param pkg
     *            the package for which to load version information, for example "org.kodtik.innovations.http". The package name
