...
package org.kodtik.ide.http.util;
...
public class VersionInfo {
     ...
     *                  for example "org.kodtik.ide.http".
     ...
     * @param pkg
     *            the package for which to load version information, for example "org.kodtik.ide.http". The package name
