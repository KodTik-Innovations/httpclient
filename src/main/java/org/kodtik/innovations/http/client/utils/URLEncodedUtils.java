...
package org.kodtik.innovations.http.client.utils;
...
import org.kodtik.innovations.http.message.TokenParser;
...
public class URLEncodedUtils {
     ...
     *            Encoding to use when decoding the parameters.
     *
     * @deprecated (4.4) use {@link #parse(org.kodtik.innovations.http.util.CharArrayBuffer, java.nio.charset.Charset, char...)}
     */
    @Deprecated
    public static void parse(
            final List <NameValuePair> parameters,
