...
package org.kodtik.innovations.http.client.protocol;
...
import org.kodtik.innovations.http.client.AuthCache;
...
import org.kodtik.innovations.http.conn.routing.RouteInfo;
import org.kodtik.innovations.http.cookie.CookieOrigin;
import org.kodtik.innovations.http.cookie.CookieSpec;
...
public class HttpClientContext extends HttpCoreContext {
    ...
    /**
     * Attribute name of a {@link org.kodtik.innovations.http.conn.routing.RouteInfo}
    ...
    /**
     * Attribute name of a {@link org.kodtik.innovations.http.config.Lookup} object that represents
     * the actual {@link CookieSpecProvider} registry.
     */
    public static final String COOKIESPEC_REGISTRY   = "http.cookiespec-registry";

    /**
     * Attribute name of a {@link org.kodtik.innovations.http.cookie.CookieSpec}
     * object that represents the actual cookie specification.
     */
    public static final String COOKIE_SPEC           = "http.cookie-spec";

    /**
     * Attribute name of a {@link org.kodtik.innovations.http.cookie.CookieOrigin}
     * object that represents the actual details of the origin server.
     */
    public static final String COOKIE_ORIGIN         = "http.cookie-origin";

    /**
     * Attribute name of a {@link org.kodtik.innovations.http.client.CookieStore}
     * object that represents the actual cookie store.
     */
    public static final String COOKIE_STORE          = "http.cookie-store";

    /**
     * Attribute name of a {@link org.kodtik.innovations.http.client.CredentialsProvider}
     * object that represents the actual credentials provider.
     */
    public static final String CREDS_PROVIDER        = "http.auth.credentials-provider";

    /**
     * Attribute name of a {@link org.kodtik.innovations.http.client.AuthCache} object
     * that represents the auth scheme cache.
     */
    public static final String AUTH_CACHE            = "http.auth.auth-cache";

    /**
     * Attribute name of a {@link org.kodtik.innovations.http.auth.AuthState}
    ...
    /**
     * Attribute name of a {@link org.kodtik.innovations.http.client.config.RequestConfig} object that
