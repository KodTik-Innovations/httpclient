...
package org.kodtik.innovations.http.client.config;
...
public class RequestConfig implements Cloneable {
    ...
    */
     ...
     *   org.kodtik.innovations.http.impl.conn.PoolingHttpClientConnectionManager#getValidateAfterInactivity()}
     */
    @Deprecated
    ...
    public static class Builder {
        ...
        /**
         * @deprecated (4.4) Use {@link
         *   org.kodtik.innovations.http.impl.conn.PoolingHttpClientConnectionManager#setValidateAfterInactivity(int)}
         */
        @Deprecated
