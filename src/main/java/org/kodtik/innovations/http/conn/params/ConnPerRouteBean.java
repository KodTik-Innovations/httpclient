 ...
 * {@link org.kodtik.innovations.http.conn.ClientConnectionManager connection managers} for
 * a fine-grained control of connections on a per route basis.
 *
 * @since 4.0
 *
 * @deprecated (4.2)  use {@link org.kodtik.innovations.http.pool.ConnPoolControl}
 */
@Deprecated
