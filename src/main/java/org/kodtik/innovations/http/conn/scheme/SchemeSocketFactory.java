...
package org.kodtik.innovations.http.conn.scheme;
 ...
 * @since 4.1
 *
 * @deprecated (4.3) use {@link org.kodtik.innovations.http.conn.socket.ConnectionSocketFactory}
 */
@Deprecated
public interface SchemeSocketFactory {
     ...
     * <p>
     * Please note that {@link org.kodtik.innovations.http.conn.HttpInetSocketAddress} class should
     * be used in order to pass the target remote address along with the original
     * {@link org.kodtik.innovations.http.HttpHost} value used to resolve the address. The use of
     * {@link org.kodtik.innovations.http.conn.HttpInetSocketAddress} can also ensure that no reverse
     ...
     *
     * @see org.kodtik.innovations.http.conn.HttpInetSocketAddress
     */
