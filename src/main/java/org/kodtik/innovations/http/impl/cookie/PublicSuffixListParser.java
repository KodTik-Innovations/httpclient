 ...
 *
 * @deprecated (4.4) use {@link org.kodtik.innovations.http.conn.util.PublicSuffixListParser}.
 *
 * @since 4.0
 */
...
public class PublicSuffixListParser {
    ...
    private final org.kodtik.innovations.http.conn.util.PublicSuffixListParser parser;

    PublicSuffixListParser(final PublicSuffixFilter filter) {
        this.filter = filter;
        this.parser = new org.kodtik.innovations.http.conn.util.PublicSuffixListParser();
    }
