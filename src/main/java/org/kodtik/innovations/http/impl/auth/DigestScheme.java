 ...
 *
 */
package org.kodtik.innovations.http.impl.auth;
...
import org.kodtik.innovations.http.Consts;
...
import org.kodtik.innovations.http.auth.AuthenticationException;
import org.kodtik.innovations.http.auth.ChallengeState;
import org.kodtik.innovations.http.auth.Credentials;
import org.kodtik.innovations.http.auth.MalformedChallengeException;
import org.kodtik.innovations.http.message.BasicHeaderValueFormatter;
import org.kodtik.innovations.http.message.BasicNameValuePair;
import org.kodtik.innovations.http.message.BufferedHeader;
...
import org.kodtik.innovations.http.util.CharArrayBuffer;
import org.kodtik.innovations.http.util.EncodingUtils;
...
public class DigestScheme extends RFC2617Scheme {
    ...
    /**
     * @deprecated (4.2) Use {@link org.kodtik.innovations.http.auth.ContextAwareAuthScheme#authenticate(
     *   Credentials, HttpRequest, org.kodtik.innovations.http.protocol.HttpContext)}
     */
    @Override
    @Deprecated
     ...
     *
     * @throws org.kodtik.innovations.http.auth.InvalidCredentialsException if authentication credentials
