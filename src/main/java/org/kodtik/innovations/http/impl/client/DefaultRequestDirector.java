...
import org.kodtik.innovations.http.HttpEntity;
import org.kodtik.innovations.http.HttpEntityEnclosingRequest;
import org.kodtik.innovations.http.HttpException;
...
import org.kodtik.innovations.http.NoHttpResponseException;
import org.kodtik.innovations.http.ProtocolException;
import org.kodtik.innovations.http.ProtocolVersion;
import org.kodtik.innovations.http.auth.AuthProtocolState;
import org.kodtik.innovations.http.auth.AuthScheme;
import org.kodtik.innovations.http.auth.AuthState;
import org.kodtik.innovations.http.auth.UsernamePasswordCredentials;
import org.kodtik.innovations.http.client.AuthenticationHandler;
...
import org.kodtik.innovations.http.client.NonRepeatableRequestException;
import org.kodtik.innovations.http.client.RedirectException;
import org.kodtik.innovations.http.client.RedirectHandler;
import org.kodtik.innovations.http.client.RedirectStrategy;
import org.kodtik.innovations.http.client.RequestDirector;
import org.kodtik.innovations.http.client.UserTokenHandler;
import org.kodtik.innovations.http.client.methods.AbortableHttpRequest;
import org.kodtik.innovations.http.client.methods.HttpUriRequest;
import org.kodtik.innovations.http.client.params.ClientPNames;
import org.kodtik.innovations.http.client.params.HttpClientParams;
import org.kodtik.innovations.http.client.protocol.ClientContext;
import org.kodtik.innovations.http.client.utils.URIUtils;
import org.kodtik.innovations.http.conn.BasicManagedEntity;
import org.kodtik.innovations.http.conn.ClientConnectionManager;
...
import org.kodtik.innovations.http.conn.ManagedClientConnection;
import org.kodtik.innovations.http.conn.routing.BasicRouteDirector;
import org.kodtik.innovations.http.conn.routing.HttpRoute;
import org.kodtik.innovations.http.conn.routing.HttpRouteDirector;
import org.kodtik.innovations.http.conn.routing.HttpRoutePlanner;
import org.kodtik.innovations.http.conn.scheme.Scheme;
import org.kodtik.innovations.http.entity.BufferedHttpEntity;
import org.kodtik.innovations.http.impl.auth.BasicScheme;
import org.kodtik.innovations.http.impl.conn.ConnectionShutdownException;
import org.kodtik.innovations.http.message.BasicHttpRequest;
import org.kodtik.innovations.http.params.HttpConnectionParams;
import org.kodtik.innovations.http.params.HttpParams;
import org.kodtik.innovations.http.params.HttpProtocolParams;
import org.kodtik.innovations.http.protocol.ExecutionContext;
...
import org.kodtik.innovations.http.util.EntityUtils;
 ...
 * class:
 * <ul>
 *  <li>{@link org.kodtik.innovations.http.params.CoreProtocolPNames#PROTOCOL_VERSION}</li>
 *  <li>{@link org.kodtik.innovations.http.params.CoreProtocolPNames#STRICT_TRANSFER_ENCODING}</li>
 *  <li>{@link org.kodtik.innovations.http.params.CoreProtocolPNames#HTTP_ELEMENT_CHARSET}</li>
 *  <li>{@link org.kodtik.innovations.http.params.CoreProtocolPNames#USE_EXPECT_CONTINUE}</li>
 *  <li>{@link org.kodtik.innovations.http.params.CoreProtocolPNames#WAIT_FOR_CONTINUE}</li>
 *  <li>{@link org.kodtik.innovations.http.params.CoreProtocolPNames#USER_AGENT}</li>
 *  <li>{@link org.kodtik.innovations.http.params.CoreConnectionPNames#SOCKET_BUFFER_SIZE}</li>
 *  <li>{@link org.kodtik.innovations.http.params.CoreConnectionPNames#MAX_LINE_LENGTH}</li>
 *  <li>{@link org.kodtik.innovations.http.params.CoreConnectionPNames#MAX_HEADER_COUNT}</li>
 *  <li>{@link org.kodtik.innovations.http.params.CoreConnectionPNames#SO_TIMEOUT}</li>
 *  <li>{@link org.kodtik.innovations.http.params.CoreConnectionPNames#SO_LINGER}</li>
 *  <li>{@link org.kodtik.innovations.http.params.CoreConnectionPNames#SO_REUSEADDR}</li>
 *  <li>{@link org.kodtik.innovations.http.params.CoreConnectionPNames#TCP_NODELAY}</li>
 *  <li>{@link org.kodtik.innovations.http.params.CoreConnectionPNames#CONNECTION_TIMEOUT}</li>
 *  <li>{@link org.kodtik.innovations.http.params.CoreConnectionPNames#STALE_CONNECTION_CHECK}</li>
 *  <li>{@link org.kodtik.innovations.http.conn.params.ConnRoutePNames#FORCED_ROUTE}</li>
 *  <li>{@link org.kodtik.innovations.http.conn.params.ConnRoutePNames#LOCAL_ADDRESS}</li>
 *  <li>{@link org.kodtik.innovations.http.conn.params.ConnRoutePNames#DEFAULT_PROXY}</li>
 *  <li>{@link org.kodtik.innovations.http.cookie.params.CookieSpecPNames#DATE_PATTERNS}</li>
 *  <li>{@link org.kodtik.innovations.http.cookie.params.CookieSpecPNames#SINGLE_COOKIE_HEADER}</li>
 *  <li>{@link org.kodtik.innovations.http.auth.params.AuthPNames#CREDENTIAL_CHARSET}</li>
 *  <li>{@link org.kodtik.innovations.http.client.params.ClientPNames#COOKIE_POLICY}</li>
 *  <li>{@link org.kodtik.innovations.http.client.params.ClientPNames#HANDLE_AUTHENTICATION}</li>
 *  <li>{@link org.kodtik.innovations.http.client.params.ClientPNames#HANDLE_REDIRECTS}</li>
 *  <li>{@link org.kodtik.innovations.http.client.params.ClientPNames#MAX_REDIRECTS}</li>
 *  <li>{@link org.kodtik.innovations.http.client.params.ClientPNames#ALLOW_CIRCULAR_REDIRECTS}</li>
 *  <li>{@link org.kodtik.innovations.http.client.params.ClientPNames#VIRTUAL_HOST}</li>
 *  <li>{@link org.kodtik.innovations.http.client.params.ClientPNames#DEFAULT_HOST}</li>
 *  <li>{@link org.kodtik.innovations.http.client.params.ClientPNames#DEFAULT_HEADERS}</li>
 *  <li>{@link org.kodtik.innovations.http.client.params.ClientPNames#CONN_MANAGER_TIMEOUT}</li>
 * </ul>
 *
 * @since 4.0
 *
