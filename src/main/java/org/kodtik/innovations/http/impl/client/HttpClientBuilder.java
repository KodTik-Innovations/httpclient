...
import org.kodtik.innovations.http.ConnectionReuseStrategy;
import org.kodtik.innovations.http.Header;
import org.kodtik.innovations.http.HttpHost;
import org.kodtik.innovations.http.HttpRequestInterceptor;
import org.kodtik.innovations.http.HttpResponseInterceptor;
import org.kodtik.innovations.http.auth.AuthSchemeProvider;
import org.kodtik.innovations.http.client.AuthenticationStrategy;
import org.kodtik.innovations.http.client.BackoffManager;
import org.kodtik.innovations.http.client.ConnectionBackoffStrategy;
import org.kodtik.innovations.http.client.CookieStore;
import org.kodtik.innovations.http.client.CredentialsProvider;
import org.kodtik.innovations.http.client.HttpRequestRetryHandler;
import org.kodtik.innovations.http.client.RedirectStrategy;
import org.kodtik.innovations.http.client.ServiceUnavailableRetryStrategy;
import org.kodtik.innovations.http.client.UserTokenHandler;
import org.kodtik.innovations.http.client.config.AuthSchemes;
import org.kodtik.innovations.http.client.config.RequestConfig;
import org.kodtik.innovations.http.client.entity.InputStreamFactory;
import org.kodtik.innovations.http.client.protocol.RequestAcceptEncoding;
import org.kodtik.innovations.http.client.protocol.RequestAddCookies;
import org.kodtik.innovations.http.client.protocol.RequestAuthCache;
import org.kodtik.innovations.http.client.protocol.RequestClientConnControl;
import org.kodtik.innovations.http.client.protocol.RequestDefaultHeaders;
import org.kodtik.innovations.http.client.protocol.RequestExpectContinue;
import org.kodtik.innovations.http.client.protocol.ResponseContentEncoding;
import org.kodtik.innovations.http.client.protocol.ResponseProcessCookies;
import org.kodtik.innovations.http.config.ConnectionConfig;
import org.kodtik.innovations.http.config.Lookup;
import org.kodtik.innovations.http.config.RegistryBuilder;
import org.kodtik.innovations.http.config.SocketConfig;
import org.kodtik.innovations.http.conn.ConnectionKeepAliveStrategy;
import org.kodtik.innovations.http.conn.DnsResolver;
import org.kodtik.innovations.http.conn.HttpClientConnectionManager;
import org.kodtik.innovations.http.conn.SchemePortResolver;
import org.kodtik.innovations.http.conn.routing.HttpRoutePlanner;
import org.kodtik.innovations.http.conn.socket.ConnectionSocketFactory;
import org.kodtik.innovations.http.conn.socket.LayeredConnectionSocketFactory;
import org.kodtik.innovations.http.conn.socket.PlainConnectionSocketFactory;
import org.kodtik.innovations.http.conn.ssl.DefaultHostnameVerifier;
import org.kodtik.innovations.http.conn.ssl.SSLConnectionSocketFactory;
import org.kodtik.innovations.http.conn.ssl.X509HostnameVerifier;
import org.kodtik.innovations.http.conn.util.PublicSuffixMatcher;
import org.kodtik.innovations.http.conn.util.PublicSuffixMatcherLoader;
import org.kodtik.innovations.http.cookie.CookieSpecProvider;
import org.kodtik.innovations.http.impl.NoConnectionReuseStrategy;
import org.kodtik.innovations.http.impl.auth.BasicSchemeFactory;
import org.kodtik.innovations.http.impl.auth.DigestSchemeFactory;
import org.kodtik.innovations.http.impl.auth.KerberosSchemeFactory;
import org.kodtik.innovations.http.impl.auth.NTLMSchemeFactory;
import org.kodtik.innovations.http.impl.auth.SPNegoSchemeFactory;
import org.kodtik.innovations.http.impl.conn.DefaultProxyRoutePlanner;
import org.kodtik.innovations.http.impl.conn.DefaultRoutePlanner;
import org.kodtik.innovations.http.impl.conn.DefaultSchemePortResolver;
import org.kodtik.innovations.http.impl.conn.PoolingHttpClientConnectionManager;
import org.kodtik.innovations.http.impl.conn.SystemDefaultRoutePlanner;
import org.kodtik.innovations.http.impl.execchain.BackoffStrategyExec;
import org.kodtik.innovations.http.impl.execchain.ClientExecChain;
import org.kodtik.innovations.http.impl.execchain.MainClientExec;
import org.kodtik.innovations.http.impl.execchain.ProtocolExec;
import org.kodtik.innovations.http.impl.execchain.RedirectExec;
import org.kodtik.innovations.http.impl.execchain.RetryExec;
import org.kodtik.innovations.http.impl.execchain.ServiceUnavailableRetryExec;
import org.kodtik.innovations.http.protocol.HttpProcessor;
import org.kodtik.innovations.http.protocol.HttpProcessorBuilder;
import org.kodtik.innovations.http.protocol.HttpRequestExecutor;
import org.kodtik.innovations.http.protocol.ImmutableHttpProcessor;
import org.kodtik.innovations.http.protocol.RequestContent;
import org.kodtik.innovations.http.protocol.RequestTargetHost;
import org.kodtik.innovations.http.protocol.RequestUserAgent;
import org.kodtik.innovations.http.ssl.SSLContexts;
import org.kodtik.innovations.http.util.TextUtils;
import org.kodtik.innovations.http.util.VersionInfo;
...
public class HttpClientBuilder {
     ...
     *   org.kodtik.innovations.http.conn.HttpClientConnectionManager)} and the {@link #setSSLSocketFactory(
     *   org.kodtik.innovations.http.conn.socket.LayeredConnectionSocketFactory)} methods.
     * </p>
     *
     *   @deprecated (4.4)
     */
     ...
     * with {@link org.kodtik.innovations.http.conn.util.PublicSuffixMatcherLoader}.
     *
     * @see org.kodtik.innovations.http.conn.util.PublicSuffixMatcher
     * @see org.kodtik.innovations.http.conn.util.PublicSuffixMatcherLoader
     *
     *   @since 4.4
     */
     ...
     * <p>
     * Please note this value can be overridden by the {@link #setConnectionManager(
     *   org.kodtik.innovations.http.conn.HttpClientConnectionManager)} method.
     * </p>
     */
     ...
     * org.kodtik.innovations.http.protocol.HttpProcessor)} method.
     * </p>
     */
     ...
     *   org.kodtik.innovations.http.conn.routing.HttpRoutePlanner)} method.
     */
...
`     */
    ...
    /**
     * Assigns default {@link org.kodtik.innovations.http.auth.AuthScheme} registry which will
    ...
    /**
     * Assigns default {@link org.kodtik.innovations.http.cookie.CookieSpec} registry which will
     * be used for request execution if not explicitly set in the client execution
     * context.
     *
     * @see org.kodtik.innovations.http.impl.client.CookieSpecRegistries
     *
     */
    ...
    /**
     * Assigns a map of {@link org.kodtik.innovations.http.client.entity.InputStreamFactory}s
     ...
     * @see org.kodtik.innovations.http.conn.HttpClientConnectionManager#closeExpiredConnections()
     *
     * @since 4.4
     */
        ...
        if (userAgentCopy == null) {
            ...
            if (userAgentCopy == null && !defaultUserAgentDisabled) {
                userAgentCopy = VersionInfo.getUserAgent("Apache-HttpClient",
                        "org.kodtik.innovations.http.client", getClass());
            }
        }
