...
package org.kodtik.innovations.http.auth.params;
 ...
 * @since 4.0
 *
 * @deprecated (4.3) use {@link org.kodtik.innovations.http.client.config.RequestConfig}
 *   and constructor parameters of
 *   {@link org.kodtik.innovations.http.auth.AuthSchemeProvider}s.
*/
@Deprecated
public interface AuthPNames {
     ...
     * {@link org.kodtik.innovations.http.auth.Credentials}.
     * <p>
     ...
     *  {@link org.kodtik.innovations.http.auth.AuthScheme}s when authenticating with
     *  the target host.
     * <p>
     ...
     * {@link org.kodtik.innovations.http.auth.AuthScheme#getSchemeName()}.
     */
    String TARGET_AUTH_PREF = "http.auth.target-scheme-pref";

    /**
     * Defines the order of preference for supported
     *  {@link org.kodtik.innovations.http.auth.AuthScheme}s when authenticating with the
     *  proxy host.
     * <p>
     * This parameter expects a value of type {@link java.util.Collection}. The
     * collection is expected to contain {@link String} instances representing
