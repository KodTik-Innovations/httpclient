 ...
 * @since 4.0
 *
 * @deprecated (4.3) use {@link org.kodtik.ide.http.conn.SchemePortResolver} for default port
 * resolution and {@link org.kodtik.ide.http.config.Registry} for socket factory lookups.
 */
