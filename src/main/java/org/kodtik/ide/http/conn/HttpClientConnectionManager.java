 ...
 *
 */
package org.kodtik.ide.http.conn;
...
public interface HttpClientConnectionManager {
     ...
     * by calling {@link #connect(org.kodtik.ide.http.HttpClientConnection,
     *   org.kodtik.ide.http.conn.routing.HttpRoute, int,
     *   org.kodtik.ide.http.protocol.HttpContext) connect} in order to connect
     * directly to the target or to the first proxy hop, optionally calling
     * {@link #upgrade(org.kodtik.ide.http.HttpClientConnection,
     *   org.kodtik.ide.http.conn.routing.HttpRoute,
     *   org.kodtik.ide.http.protocol.HttpContext) upgrade} method to upgrade
     ...
     *  org.kodtik.ide.http.HttpClientConnection,
     *  org.kodtik.ide.http.conn.routing.HttpRoute,
     *  org.kodtik.ide.http.protocol.HttpContext) routeComplete} to mark the route
     *  as fully completed.
     * </p>
     *
