...
import org.kodtik.ide.http.impl.io.DefaultHttpRequestWriterFactory;
...
public class ManagedHttpClientConnectionFactory
    ...
    private final Log headerLog = LogFactory.getLog("org.kodtik.ide.http.headers");
    private final Log wireLog = LogFactory.getLog("org.kodtik.ide.http.wire");
