...
import org.kodtik.ide.http.client.BackoffManager;
import org.kodtik.ide.http.client.ConnectionBackoffStrategy;
...
import org.kodtik.ide.http.client.protocol.RequestAcceptEncoding;
...
import org.kodtik.ide.http.client.protocol.RequestExpectContinue;
import org.kodtik.ide.http.client.protocol.ResponseContentEncoding;
...
import org.kodtik.ide.http.conn.DnsResolver;
...
import org.kodtik.ide.http.conn.socket.LayeredConnectionSocketFactory;
import org.kodtik.ide.http.conn.socket.PlainConnectionSocketFactory;
import org.kodtik.ide.http.conn.ssl.DefaultHostnameVerifier;
import org.kodtik.ide.http.conn.ssl.SSLConnectionSocketFactory;
import org.kodtik.ide.http.conn.ssl.X509HostnameVerifier;
import org.kodtik.ide.http.conn.util.PublicSuffixMatcher;
import org.kodtik.ide.http.conn.util.PublicSuffixMatcherLoader;
...
import org.kodtik.ide.http.impl.conn.DefaultProxyRoutePlanner;
import org.kodtik.ide.http.impl.conn.DefaultRoutePlanner;
...
import org.kodtik.ide.http.impl.conn.SystemDefaultRoutePlanner;
import org.kodtik.ide.http.impl.execchain.BackoffStrategyExec;
import org.kodtik.ide.http.impl.execchain.ClientExecChain;
import org.kodtik.ide.http.impl.execchain.MainClientExec;
import org.kodtik.ide.http.impl.execchain.ProtocolExec;
import org.kodtik.ide.http.impl.execchain.RedirectExec;
import org.kodtik.ide.http.impl.execchain.RetryExec;
import org.kodtik.ide.http.impl.execchain.ServiceUnavailableRetryExec;
import org.kodtik.ide.http.protocol.HttpProcessor;
import org.kodtik.ide.http.protocol.HttpProcessorBuilder;
...
import org.kodtik.ide.http.ssl.SSLContexts;
...
public class HttpClientBuilder {
     ...
     *   org.kodtik.ide.http.conn.HttpClientConnectionManager)} and the {@link #setSSLSocketFactory(
     *   org.kodtik.ide.http.conn.socket.LayeredConnectionSocketFactory)} methods.
     * </p>
     *
     *   @deprecated (4.4)
     */
     ...
     * with {@link org.kodtik.ide.http.conn.util.PublicSuffixMatcherLoader}.
     *
     * @see org.kodtik.ide.http.conn.util.PublicSuffixMatcher
     * @see org.kodtik.ide.http.conn.util.PublicSuffixMatcherLoader
     *
     *   @since 4.4
     */
     ...
     * <p>
     * Please note this value can be overridden by the {@link #setConnectionManager(
     *   org.kodtik.ide.http.conn.HttpClientConnectionManager)} method.
     * </p>
     */
     ...
     * org.kodtik.ide.http.protocol.HttpProcessor)} method.
     * </p>
     */
     ...
     *   org.kodtik.ide.http.conn.routing.HttpRoutePlanner)} method.
     */
...
`     */
    ...
    /**
     * Assigns default {@link org.kodtik.ide.http.auth.AuthScheme} registry which will
    ...
    /**
     * Assigns default {@link org.kodtik.ide.http.cookie.CookieSpec} registry which will
     * be used for request execution if not explicitly set in the client execution
     * context.
     *
     * @see org.kodtik.ide.http.impl.client.CookieSpecRegistries
     *
     */
    ...
    /**
     * Assigns a map of {@link org.kodtik.ide.http.client.entity.InputStreamFactory}s
     ...
     * @see org.kodtik.ide.http.conn.HttpClientConnectionManager#closeExpiredConnections()
     *
     * @since 4.4
     */
        ...
        if (userAgentCopy == null) {
            ...
            if (userAgentCopy == null && !defaultUserAgentDisabled) {
                userAgentCopy = VersionInfo.getUserAgent("Apache-HttpClient",
                        "org.kodtik.ide.http.client", getClass());
            }
        }
