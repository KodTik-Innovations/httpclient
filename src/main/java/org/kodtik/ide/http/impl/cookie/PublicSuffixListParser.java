...
import org.kodtik.ide.http.conn.util.PublicSuffixList;

/**
 * Parses the list from <a href="http://publicsuffix.org/">publicsuffix.org</a>
 * and configures a PublicSuffixFilter.
 *
 * @deprecated (4.4) use {@link org.kodtik.ide.http.conn.util.PublicSuffixListParser}.
 *
 * @since 4.0
 */
...
public class PublicSuffixListParser {
    ...
    private final org.kodtik.ide.http.conn.util.PublicSuffixListParser parser;

    PublicSuffixListParser(final PublicSuffixFilter filter) {
        this.filter = filter;
        this.parser = new org.kodtik.ide.http.conn.util.PublicSuffixListParser();
    }
