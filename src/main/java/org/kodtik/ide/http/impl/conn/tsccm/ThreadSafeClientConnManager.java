 ...
 *
 */
package org.kodtik.ide.http.impl.conn.tsccm;
...
import org.kodtik.ide.http.conn.ConnectionPoolTimeoutException;
import org.kodtik.ide.http.conn.ManagedClientConnection;
import org.kodtik.ide.http.conn.params.ConnPerRouteBean;
import org.kodtik.ide.http.conn.routing.HttpRoute;
import org.kodtik.ide.http.conn.scheme.SchemeRegistry;
import org.kodtik.ide.http.impl.conn.DefaultClientConnectionOperator;
...
/**
 * Manages a pool of {@link org.kodtik.ide.http.conn.OperatedClientConnection }
 ...
 * @since 4.0
 *
 * @deprecated (4.2)  use {@link org.kodtik.ide.http.impl.conn.PoolingHttpClientConnectionManager}
 */
