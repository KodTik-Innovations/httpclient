...
import org.kodtik.ide.http.auth.ChallengeState;
import org.kodtik.ide.http.auth.Credentials;
import org.kodtik.ide.http.auth.MalformedChallengeException;
import org.kodtik.ide.http.message.BasicHeaderValueFormatter;
import org.kodtik.ide.http.message.BasicNameValuePair;
import org.kodtik.ide.http.message.BufferedHeader;
...
import org.kodtik.ide.http.util.EncodingUtils;
...
public class DigestScheme extends RFC2617Scheme {
    ...
    /**
     * @deprecated (4.2) Use {@link org.kodtik.ide.http.auth.ContextAwareAuthScheme#authenticate(
     *   Credentials, HttpRequest, org.kodtik.ide.http.protocol.HttpContext)}
     */
    @Override
    @Deprecated
     ...
     *
     * @throws org.kodtik.ide.http.auth.InvalidCredentialsException if authentication credentials
