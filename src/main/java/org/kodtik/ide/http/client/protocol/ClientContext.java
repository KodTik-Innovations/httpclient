...
/**
 * {@link org.kodtik.ide.http.protocol.HttpContext} attribute names for
...
public interface ClientContext {
    ...
    /**
     * Attribute name of a {@link org.kodtik.ide.http.conn.routing.RouteInfo}
    ...
    /**
     * Attribute name of a {@link org.kodtik.ide.http.conn.scheme.Scheme}
     * object that represents the actual protocol scheme registry.
     */
    String SCHEME_REGISTRY   = "http.scheme-registry";

    /**
     * Attribute name of a {@link org.kodtik.ide.http.config.Lookup} object that represents
     * the actual {@link org.kodtik.ide.http.cookie.CookieSpecRegistry} registry.
     */
    String COOKIESPEC_REGISTRY   = "http.cookiespec-registry";

    /**
     * Attribute name of a {@link org.kodtik.ide.http.cookie.CookieSpec}
     * object that represents the actual cookie specification.
     */
    String COOKIE_SPEC           = "http.cookie-spec";

    /**
     * Attribute name of a {@link org.kodtik.ide.http.cookie.CookieOrigin}
     * object that represents the actual details of the origin server.
     */
    String COOKIE_ORIGIN         = "http.cookie-origin";

    /**
     * Attribute name of a {@link org.kodtik.ide.http.client.CookieStore}
     * object that represents the actual cookie store.
     */
    String COOKIE_STORE          = "http.cookie-store";

    /**
     * Attribute name of a {@link org.kodtik.ide.http.client.CredentialsProvider}
     * object that represents the actual credentials provider.
     */
    String CREDS_PROVIDER        = "http.auth.credentials-provider";

    /**
     * Attribute name of a {@link org.kodtik.ide.http.client.AuthCache} object
     * that represents the auth scheme cache.
     */
    String AUTH_CACHE            = "http.auth.auth-cache";

    /**
     * Attribute name of a {@link org.kodtik.ide.http.auth.AuthState}
    ...
    /**
     * Attribute name of a {@link org.kodtik.ide.http.config.Lookup} object that represents
     * the actual {@link org.kodtik.ide.http.auth.AuthSchemeRegistry} registry.
     */
    ...
    /**
     * Attribute name of a {@link org.kodtik.ide.http.client.config.RequestConfig} object that
