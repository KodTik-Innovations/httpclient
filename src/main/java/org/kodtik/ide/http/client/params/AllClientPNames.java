 ...
 *
 */
package org.kodtik.ide.http.client.params;

import org.kodtik.ide.http.auth.params.AuthPNames;
import org.kodtik.ide.http.conn.params.ConnConnectionPNames;
import org.kodtik.ide.http.conn.params.ConnManagerPNames;
import org.kodtik.ide.http.conn.params.ConnRoutePNames;
import org.kodtik.ide.http.cookie.params.CookieSpecPNames;
import org.kodtik.ide.http.params.CoreConnectionPNames;
 ...
 *
 * @deprecated (4.3) use
 *   {@link org.kodtik.ide.http.client.config.RequestConfig},
 *   {@link org.kodtik.ide.http.config.ConnectionConfig},
 *   {@link org.kodtik.ide.http.config.SocketConfig}
 */
@Deprecated
