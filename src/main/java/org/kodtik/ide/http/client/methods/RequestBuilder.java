...
import org.kodtik.ide.http.Consts;
import org.kodtik.ide.http.Header;
import org.kodtik.ide.http.HeaderIterator;
...
import org.kodtik.ide.http.NameValuePair;
import org.kodtik.ide.http.ProtocolVersion;
import org.kodtik.ide.http.client.config.RequestConfig;
import org.kodtik.ide.http.client.entity.UrlEncodedFormEntity;
import org.kodtik.ide.http.client.utils.URIBuilder;
import org.kodtik.ide.http.client.utils.URLEncodedUtils;
import org.kodtik.ide.http.entity.ContentType;
import org.kodtik.ide.http.message.BasicHeader;
import org.kodtik.ide.http.message.BasicNameValuePair;
import org.kodtik.ide.http.message.HeaderGroup;
 ...
 * {@link #setEntity(org.kodtik.ide.http.HttpEntity)} or it is not an entity enclosing method
